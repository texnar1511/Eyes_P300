        ...
        while self.running:
            ...
            for char, params in self.cells.items():
                ...
                if self.start_experiment:
                    ...
                    self.screen.blit(params['letter'], (i * self.w + self.w / 2 - params['letter'].get_width() / 2, j * self.h + self.h / 2 - params['letter'].get_height() / 2))
                    
                    pygame.draw.circle(self.screen, params['circle_color'], (i * self.w + self.w / 2 + dx, j * self.h + self.h / 2 - dy), self.circle_radius, 0)
